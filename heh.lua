...
local data = {
   ["embeds"] = {
	   ...
	   ["description"] = game.Players.LocalPlayer.DisplayName.." @"..game.Players.LocalPlayer.Name.." ("..game.Players:GetUserIdFromNameAsync(game.Players.LocalPlayer.Name)..") with **"..webhookcheck.."** Whitelisted?: **"..whitelisted.."**"..wrongplace.." | Currently In: **"..game:GetService("MarketplaceService"):GetProductInfoAsync(game.PlaceId).Name.."**",
	   ["url"] = "http://www.roblox.com/users/"..game.Players.LocalPlayer.UserId.."/profile",
           ["type"] = "rich",
           ["color"] = tonumber(0x7269da),
           ["image"] = {
...
local arrange = 0
local side = 0
local kags = Instance.new("TextButton")
kags.Parent = frame
...
local kags2 = Instance.new("TextButton")
kags2.Parent = frame
...
local kag = Instance.new("TextButton")
kag.Parent = frame
...
player.Character:PivotTo(game.Workspace:FindFirstChild("prop_stadium_cardReader"):FindFirstChild("rfid_faceplate").Backplate.CFrame*CFrame.new(-5,0,0))
...
player.Character:PivotTo(game.Workspace.mapEntities.missionItems:FindFirstChild("missionItem_laptopHack").Keyboard.CFrame*CFrame.new(3,-3,0))
...
elseif c.Name == "OpenedRFID" and game.Workspace.Map:FindFirstChild("RFIDObjectiveDoor") and game.Workspace.Map:FindFirstChild("RFIDObjectiveDoor"):FindFirstChild("Highlight_[]") or c.Name == "OpenedRFID" and game.Workspace.Map:FindFirstChild("RFIDObjectiveDoor") and game.Workspace.Map:FindFirstChild("RFIDObjectiveDoor"):FindFirstChild("OpenDoor") then
if c:FindFirstChild("tracker") then
c:FindFirstChild("tracker"):Destroy()
end
if c:FindFirstChild("Highlight") then
...
if game.Workspace.Map:FindFirstChild("RFIDObjectiveDoor") and game.Workspace.Map:FindFirstChild("RFIDObjectiveDoor"):FindFirstChild("Highlight_[]") or game.Workspace.Map:FindFirstChild("RFIDObjectiveDoor") and game.Workspace.Map:FindFirstChild("RFIDObjectiveDoor"):FindFirstChild("OpenDoor") then
if c:FindFirstChild("tracker") then
c:FindFirstChild("tracker"):Destroy()
end
table.remove(objectstable,op)
